...
const Banner = ({tikitCount}) => {
    return (
        <div className='bg-[#e6ecf1]'>
                <div className='max-w-[1200px] mx-auto  md:flex justify-between items-center gap-3 py-[40px]'>

      <div className=' w-1/2 h-[250px] flex justify-center items-center rounded-lg  mx-auto w-full my-4'
      style={{
      ...
      >
        <div className='text-white'>
          ...
          <h2 tikitCount={tikitCount} className='flex justify-center items-center text-5xl font-bold'>{tikitCount}</h2>  
        </div>
      </div>
      <div className=' w-1/2 h-[250px] flex justify-center items-center rounded-lg  mx-auto w-full'
      style={{
